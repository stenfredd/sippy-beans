...
@section('content')
<section>
    <form id="equipment-form" name="equipment_form" method="post" action="{{ url('admin/equipments/save') }}" enctype="multipart/form-data">
        @csrf
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div
                                                ...
                                                <input type="checkbox" class="custom-control-input"
                                                    ...
                                                    {{ ($equipment->status ?? 0) == 1 ? 'checked' : '' }} name="status" value="1">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="short_description"
                                            id="short_description" placeholder="Proudct Name">{{ $equipment->short_description ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <div class="card-body">
                        <div class="row">
                           ...
                           <div class="form-group">
                              ...
                              <select class="ui search dropdown w-100" id="roster_type_id" name="roster_type_id">
                                <option value="">Select Roaster Type</option>
                                @foreach ($coffeeTypes as $type)
                                <option value="{{ $type->id }}" {{ ($equipment->roster_type_id ?? '') == $type->id ? 'selected' : '' }}>
                                    {{ $type->title }}
                                </option>
                                @endforeach
                            </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" name="commission_fee" id="commission_fee" value="{{ $equipment->commission_fee ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="commission_type" id="commission_type" class="form-control">
                                        <option value="percentage" {{ ($equipment->commission_type ?? '') == 'percentage' ? 'selected' : '' }}>Percentage</option>
                                        <option value="amount" {{ ($equipment->commission_type ?? '') == 'amount' ? 'selected' : '' }}>Fixed Amount</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="add-new-banner-div">
                                            <div div class="enable-img d-flex align-items-center">
                                                ...
                                                <img src="{{ asset($image->image_path ?? 'assets/images/product-uplode.png')}}"
                                                    id="preview_image_{{ $key }}" onclick="$('#image_{{$key}}').click()">
                                            </div>
                                        </div>
