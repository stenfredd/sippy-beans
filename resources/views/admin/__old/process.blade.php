    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Processes</h2>
        ...
        <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
            <div class="form-group breadcrum-right">
                <button class="btn-icon btn btn-primary btn-round btn-sm font-small-2 font-weight-bold" type="button" onclick="showAddEditModal(this, false)">Add Process</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addEditProcessModalTitle">Add Process</h5>
...
<script type="text/javascript">
    ...
    function showAddEditModal(t, edit) {
        $('#addEditProcessModalTitle').text('Add process');
        $("#addEditProcessForm")[0].reset();
        $("#process_id").val('');
        if (edit === true) {
            $('#addEditProcessModalTitle').text('Edit process');
    ...
    function updateSortOrders() {
        ...
        $.ajax({
            url: "{{ url('admin/process/update-sort-orders') }}",
            type: "post",
            data: formData,
            contentType: false,
            processData: false,
