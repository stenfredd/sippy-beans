    ...
    <form action="{{ url('admin/banners/save') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title"
                                            placeholder="Add a title for the banner"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="url" id="url"
                                            placeholder="Add a url for the banner"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="type" name="type" class="form-control">
                                            ...
                                            <option value="product"
                                                {{ ($banner->type ?? '') == 'product' ? 'selected' : '' }}>Product
                                            </option>
                                            <option value="equipment"
                                                {{ ($banner->type ?? '') == 'equipment' ? 'selected' : '' }}>Equipment
                                            </option>
                                            <option value="subscription"
                                                {{ ($banner->type ?? '') == 'subscription' ? 'selected' : '' }}>
                                                Subscription</option>
                                        </select>
                                    </div>
                                    <div class="form-group"
                                        ...
                                        <select id="product_id" name="product_id" class="form-control ui search dropdown w-100">
                                            ...
                                            <option value="{{ $product->id }}"
                                                {{ ($banner->product_id ?? '') == $product->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group"
                                        ...
                                        <select id="equipment_id" name="equipment_id" class="form-control ui search dropdown w-100">
                                            ...
                                            <option value="{{ $equipment->id }}"
                                                {{ ($banner->equipment_id ?? '') == $equipment->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div
                                            ...
                                            <input type="checkbox" class="custom-control-input"
                                                {{ ($banner->status ?? 0) == 1 ? 'checked' : '' }} name="status"
                                                id="status" value="1">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0">
                                <div class="add-new-banner-div">
                                    <input type="file" name="image_url" id="image_url" class="file-thard d-none"
                                        accept="image/*">
                                    <div div class="enable-img d-flex align-items-center"
                                        onclick="$('#image_url').click()">
        ...
        <div class="row justify-content-end">
            <div class="col-md-6">
                ...
                @if(!empty($banner->id ?? ''))
                <button type="button"
                    class="btn btn-light  font-weight-bold btn-lg w-100 waves-effect waves-light text-dark"
                    onclick="deleteBanner()">DELETE BANNER</button>
                @endif
            </div>
        </div>
    </form>
