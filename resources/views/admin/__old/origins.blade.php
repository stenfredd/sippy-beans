    ...
    <div class="content-header row">
                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Origins</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
            <div class="form-group breadcrum-right">
                <button class="btn-icon btn btn-primary btn-round btn-sm font-small-2 font-weight-bold" type="button" onclick="showAddEditModal(this, false)">Add Origin</button>
            </div>
        </div>
    </div>
                        ...
                        <div class="card-content">
                            <div class="card-body card-dashboard">
                                <div class="table-responsive">
                                    <table class="table nowrap w-100" id="tblOrigin">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Name</th>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addEditoriginModalTitle">Add Origin</h5>
            ...
            <form id="addEditOriginForm" class="form-horizontal" action="#" onsubmit="return false;" novalidate>
                ...
                <div class="modal-body">
                    <fieldset class="form-group d-none">
                        <input type="hidden" id="origin_id" name="origin_id" class="form-control round">
                    </fieldset>


                    <fieldset class="form-group">
                        <label for="title">Origin Name</label>
                        <input type="text" id="origin_name" name="origin_name" class="form-control round" placeholder="Origin Name">
                    </fieldset>
...
<script type="text/javascript">
    let originTable = $('#tblOrigin').DataTable({
        "scrollY": 500,
        "scrollX": true,
        "processing": true,
        "serverSide": true,
    ...
    $(document).ready(function() {
        setTimeout(function() {
            ...
            $( "#tblOrigin > tbody" ).disableSelection();
        }, 2000);
    });

    function showAddEditModal(t, edit) {
        $('#addEditoriginModalTitle').text("Add Origin");
        $("#addEditOriginForm")[0].reset();
        $("#origin_id").val('');
        if (edit === true) {
            $('#addEditoriginModalTitle').text("Edit Origin");
            let originData = originTable.row($(t).parents('tr')).data();
            $("#addEditOriginForm #origin_id").val(originData.id);
            $("#addEditOriginForm #origin_name").val(originData.origin_name);
    ...
    function deleteOrigin(t) {
        let origin_id = $(t).data('id');
    ...
    function updateSortOrders() {
        ...
        let formData = new FormData();
        formData.append('_token', '{{ csrf_token() }}');
        formData.append('sorting_origins', JSON.stringify(sorting_origins));

        $.ajax({
            url: "{{ url('admin/origin/update-sort-orders') }}",
            type: "post",
            data: formData,
            contentType: false,
            processData: false,
