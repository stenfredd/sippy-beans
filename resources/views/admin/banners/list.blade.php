                  ...
                  <div class="row mt-1 justify-content-between align-items-top">
                     <div class="col-lg-7 col-md-6">
                        <form>
                           <fieldset class="form-group position-relative has-icon-right mb-1 mr-0">
                              <input type="text" class="form-control form-control-lg" id="search_banner" placeholder="Search by first/last name, user no, phone number…">
                     ...
                     <div class="col-lg-5 col-md-6">
                        <div class="d-flex justify-content-between align-items-top w-100">
                           <button type="button" class="btn btn-orange mr-1 mb-1 waves-effect waves-light btn-block btn-lg">SEARCH</button>
                           <a href="{{ url('admin/banners/create')}}" type="button" class="btn btn-outline-orange mr-0 mb-1 waves-effect waves-light btn-block btn-lg mt-0" id="search_btn">ADD NEW BANNER</a>
                        </div>
                     </div>
                  </div>
               </div>
