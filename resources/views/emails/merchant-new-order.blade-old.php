...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700;800&display=swap"
        rel="stylesheet">
    <title>Merchant New Order</title>
    <style type="text/css">
        a:hover {
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                        ...
                                        <tr>
                                            <td style="font-size:28px; color:#2c2c2c"><img
                                                    src="http://nopguru.com/email/new-order.png" width="143" height="33"
                                                    alt="" /></td>
                                        </tr>
                                        <tr>
                                            <td height="15">&nbsp;</td>
                                        ...
                                        <tr>
                                            <td><strong>Hey The Coffee Store,</strong></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                        </tr>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td class="pera" style="color:#5c5c5c; line-height:22px;">You’ve
                                                            ...
                                                            SIPPY LTD within 24-48 Hours. Here are the details.</td>
                                                    </tr>
                                                </table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                <td style="font-size:12px"><strong>SIPPY
                                                                                        LTD</strong></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="font-size:12px"><strong>1
                                                                                        Sheikh Mohammed bin Rashid
                                                                                        Blvd,</strong></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="font-size:12px">Burj Khalifa,
                                                                                    Apt 1206</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="font-size:12px">Dubai, UAE
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                ...
                                                                <tr>
                                                                    <td valign="middle">
                                                                        <table width="100%" border="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                <td class="align-left"
                                                                                    style="font-size:14px"><strong>Order
                                                                                        Date</strong></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="align-left"
                                                                                    style="font-size:12px">October 25,
                                                                                    2020</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>&nbsp;</td>
                                            ...
                                            <td class="padding">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="0"
                                                                cellpadding="0" class="product-item">
                                                                <tr>
                                                                    <td width="15%" align="center" valign="top"><img
                                                                            src="http://nopguru.com/email/product-1.png"
                                                                            width="56" height="80" alt=""
                                                                            style="width:auto" /></td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="left">
                                                                                                ...
                                                                                                <div class="product-size"
                                                                                                    style="font-size:12px; color:#1d1d1d; padding-top:5px; font-weight:600">
                                                                                                    250g Bag | Whole
                                                                                                    Bean</div>
                                                                                                <div class="product-qty1"
                                                                                                    style="color:#1d1d1d; font-size:12px;">
                                                                                                    Quantity: 1</div>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td height="1px"><img
                                                                                                    src="http://nopguru.com/email/1px.png"
                                                                                                    style="max-width:100%; height:auto"
                                                                                                    alt="" /> </td>
                                                                                        </tr>
                                                                                    </table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td width="15%" align="center" valign="top"><img
                                                                            src="http://nopguru.com/email/product-2.jpg"
                                                                            width="56" alt="" style="height:auto" />
                                                                    </td>
                                                                    <td width="82%" valign="middle" align="left">
                                                                        <table width="100%" border="0" align="left"
                                                                            cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td align="right">
                                                            <table width="65%" border="0" cellspacing="0"
                                                                cellpadding="0" style="border-top:2px #e4e5e6 solid">
                                                                <tr>
                                                                    <td height="1"></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0"
                                                                            cellpadding="0" style="line-height:24px;">
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" valign="top">SIPPY
                                                                                    Commission</td>
                                                                                <td align="right" valign="top">(AED
                                                                                    50.00)</td>
                                                                            </tr>
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" valign="top"><strong
                                                                                        style="font-weight:800">Total
                                                                                        Amount</strong></td>
                                                                                <td align="right" valign="top"><strong
                                                                                        style="font-weight:800">AED
                                                                                        475.00</strong></td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
