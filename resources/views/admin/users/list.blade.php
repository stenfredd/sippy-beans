      ...
      <div class="col-12">
         <div class="card">
            <div class="card-header">
               <h4 class="card-title">USERS<br><span class="gray">{{ $total_users ?? 0 }} REGISTERD USERS</p></span>
            </div>
            <div>
                     ...
                     <div class="row mt-1 justify-content-between align-items-top">
                        <div class="col-lg-7 col-md-7">
                           <form>
                              <fieldset class="form-group position-relative has-icon-right mb-1">
                                 <input type="text" class="form-control form-control-lg" id="search_user" placeholder="Search by first/last name, user no, phone number…">
                        ...
                        <div class="col-lg-5 col-md-5">
                           <div class="d-flex justify-content-between align-items-top w-100">
                              <button type="button" class="btn btn-orange mr-1 mb-1 waves-effect waves-light btn-block btn-lg" id="search_btn">SEARCH</button>
                              <a href="javascript:"
                                                class="btn btn-outline-orange mr-1 mb-1 waves-effect waves-light btn-block btn-lg mt-0" id="exportBtn">EXPORT</a>
                           </div>
                        </div>
                     </div>
                  </div>
