                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="left" valign="top">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img src="http://nopguru.com/email/customer-new-order-banner.jpg"
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                        ...
                                        <tr>
                                            <td style="font-size:28px; color:#2c2c2c"><img
                                                    src="http://nopguru.com/email/order-confirmed.png" width="226"
                                                    height="33" alt="" /></td>
                                        </tr>
                                        <tr>
                                            <td height="15">&nbsp;</td>
                                        ...
                                        <tr>
                                            <td>
                                                <strong>Thank You {{ $order->user->first_name }},</strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td class="pera" style="color:#5c5c5c; line-height:22px;">We’ve
                                                            ...
                                                            You should recieve your order
                                                            in {{ $order->address->city()->first()->delivery_time ?? '1-3 Business Days' }}
                                                            .
                                                        </td>
                                                    </tr>
                                                </table>
                                                                ...
                                                                <tr>
                                                                    <td valign="middle">
                                                                        <table width="100%" border="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                <td class="align-left"
                                                                                    style="font-size:12px">{{ $order->created_at->timezone($app_settings['timezone'] ?? 'UTC')->format("M d, Y") }}</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>&nbsp;</td>
                                                                            </tr>
                                            ...
                                            @foreach ($order->details as $item)
                                                <tr>
                                                    <td width="25"><img
                                                            ...
                                                            width="1"
                                                            height="14" style="display: block; height: 14px;width: 15px"
                                                            alt=""></td>
                                                        ...
                                                        <div style="width: 100%;display: block;">
                                                            ...
                                                            <div class="col-2"
                                                                ...
                                                                <div class="product-price"
                                                                     style="font-size:18px; color:#1d1d1d;">{{ ($app_settings['currency_code'] ?? 'AED') .' '. number_format($item->amount,2) }}</div>
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="right"
                                                                                    valign="top">{{ $app_settings['currency_code'] ?? 'AED' }} {{ number_format($order->total_discount, 2) }}
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="right" valign="top">
                                                                                <td align="right"
                                                                                    valign="top">{{ $app_settings['currency_code'] ?? 'AED' }}
                                    ...
                                    <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="center" valign="top">
                                                <table width="110" border="0" cellspacing="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <a href="https://www.instagram.com/sippybeans"><img
                                                                    src="http://nopguru.com/email/instagram-icon.png"
                                                                    width="18" height="18" alt="" /></a>
                                                        </td>
                                                        <td align="center">
                                                            <a href="https://www.facebook.com/sippybeans"><img
                                                                    src="http://nopguru.com/email/facebook-icon.png"
                                                                    width="9" height="18" alt="" /></a>
                                                        </td>
                                                        <td align="center">
                                                            <a href="https://www.twitter.com/sippybeans"><img
                                                                    src="http://nopguru.com/email/twitter-icon.png"
                                                                    width="21" height="18" alt="" /></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <tr>
                                            <td align="center" valign="top" style="font-size:11px; color:#848484">If you
                                                ...
                                                <a href="mailto:info@sippyme.com"
                                                   style="color:#f53e22; text-decoration:none">info@sippyme.com
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
