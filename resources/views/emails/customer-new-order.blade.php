                                                ...
                                                <td valign="middle" align="left" style="border-bottom:1px #e4e5e6 solid">
                                                    ...
                                                    <div style="width: 100%;display: block;">
                                                        ...
                                                        <div class="col-2" style="width: 33%;display: inline-block;vertical-align: middle;text-align: right;">
                                                            <div class="product-price" style="font-size:18px; color:#1d1d1d;">{{ ($app_settings['currency_code'] ?? 'AED') .' '. number_format($item->amount,2) }}</div>
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="right" valign="top">{{ $app_settings['currency_code'] ?? 'AED' }} {{ number_format($order->total_discount, 2) }}
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" valign="top">Taxes
                                                                                    &amp; Charges</td>
                                                                                <td align="right" valign="top"><td align="right" valign="top">{{ $app_settings['currency_code'] ?? 'AED' }}
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="right" valign="top"><strong
                                                                                        style="font-weight:800"><td align="right" valign="top">{{ $app_settings['currency_code'] ?? 'AED' }}
