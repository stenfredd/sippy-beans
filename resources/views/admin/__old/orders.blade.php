    ...
    <div class="content-header row">
        ...
        {{-- <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
            <div class="form-group breadcrum-right">
                <button class="btn-icon btn btn-primary btn-round btn-sm font-small-2 font-weight-bold" type="button" onclick="window.location='{{ url('admin/order_create_edit') }}'">Add Order</button>
            </div>
        </div> --}}
    </div>
