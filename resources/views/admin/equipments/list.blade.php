        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">EQUIPMENT<br><span class="gray">{{ $total_equipments ?? 0 }} PRODUCTS FOUND
                            </p></span>
                </div>
                <div>
                            ...
                            <div class="row mt-1 justify-content-between align-items-top">
                                <div class="col-lg-7 col-md-7">
                                    <form onsubmit="return false;">
                                        <fieldset class="form-group position-relative has-icon-right mb-1">
                                            <input type="text" class="form-control form-control-lg" id="search_equipment"
                                ...
                                <div class="col-lg-5 col-md-5">
                                    <div class="d-flex justify-content-between align-items-top w-100">
                                        ...
                                        <a href="{{ url('admin/equipments/create') }}" type="button"
                    ...
                    <div class="card-content">
                        <div class="table-responsive pagenation-row beans-tabal pagenation-row">
                            <table class="table table-borderless table-striped" id="tblEquipments">
                                <thead>
                                    <tr>
    ...
    let equipmentsTable = $('#tblEquipments').DataTable({
        ...
        "ajax": {
            ...
            "data": function(data) {
                ...
                data.search = $("#search_equipment").val();
            }
        },
        "columns": [
            /* {
