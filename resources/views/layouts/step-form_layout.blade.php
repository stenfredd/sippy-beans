...
<head>
    ...
    <!-- END: Common CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/dist/assets/lib/dropzone/dropzone.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/dist/assets/css/step-form.min.css')}}">
</head>
<!-- END: Head-->
<!-- BEGIN: Body-->
...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
    ...
    <!-- BEGIN: Content-->
    @yield('content')
    <script src="{{ asset('assets/dist/assets/lib/jquery.min.js')}}"></script>
    <script src="{{ asset('assets/dist/assets/lib/dropzone/dropzone.js')}}"></script>
    <script src="{{ asset('assets/dist/assets/js/step-form.min.js')}}"></script>
</body>
<!-- END: Body-->
